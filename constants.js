const FAQ  = {
  ...
  CONTENTS: [
    ...
    `Pure grass-fed and pasture-raised beef tallow is packed with vitamins A, D, E and K, and contains fatty acids for better moisturizing. It also provides an emollient skin barrier for extra protection, and won't clog pores because it works a lot like the oil our skin produces naturally.  It is an all-around powerhouse for nontoxic and effective skin care.`,
    `Clean Cow Tallow is a small, mom-owned business that is dedicated to using the best quality ingredients available. Our tallow is made from pasture-raised and exclusively grass-fed cows raised on Amish farms, ensuring a nourishing and nutrient-dense product. The honey we use is always raw to maintain its natural properties that are so helpful for skin care. Our olive oil is organic, cold-pressed, and extra virgin. And the beeswax we use is 100% pure, from a small family farm in Ohio. All of our essential oil options are also from organic sources.`,
    ...
    `As often as needed!`,
    `We would recommend trying our unscented balm or cream. Unless you have a specific allergy to beef, honey, olives,or bee propolis, our tallow balm is naturally gentle on the skin.`,
